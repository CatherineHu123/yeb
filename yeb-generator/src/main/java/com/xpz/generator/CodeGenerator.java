...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        // 数据库表映射到实体的命名策略, 转成驼峰命名
        strategy.setNaming(NamingStrategy.underline_to_camel);
        // 数据库表字段映射到实体的命名策略
        strategy.setColumnNaming(NamingStrategy.no_change); //本身是驼峰命名，不用改变
        // Lombok 模型
